...
public class noi_part1_deBai extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM noi_part1 ORDER BY RANDOM() LIMIT 1", null);
        while (cursor.moveToNext()) {
            id = cursor.getInt(cursor.getColumnIndexOrThrow("id"));
            doanVan = cursor.getString(cursor.getColumnIndexOrThrow("paragram"));
        }
        cursor.close();
        txt_doanVan.setText(doanVan);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(noi_part1_deBai.this, noi_part2_cauHoi.class);
    ...
    private void startSpeechRecognition() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            @Override public void onError(int error) {
                if(error == 7) {
                    Toast.makeText(noi_part1_deBai.this, "No speech input recognized. Please try again.", Toast.LENGTH_SHORT).show();
                } else {
