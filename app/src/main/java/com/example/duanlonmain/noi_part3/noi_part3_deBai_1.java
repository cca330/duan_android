...
public class noi_part3_deBai_1 extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_cauHoi.setText(getIntent().getStringExtra("q1"));
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(noi_part3_deBai_1.this);
                builder.setTitle("Xác nhận");
                builder.setMessage("Bạn có chắc muốn quay lại không? Bài làm của bạn sẽ không được lưu.");
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(noi_part3_deBai_1.this, noi_part3_cauHoi.class);
    ...
    private void startSpeechRecognition() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            @Override public void onError(int error) {
                if(error == 7) {
                    Toast.makeText(noi_part3_deBai_1.this, "No speech input recognized. Please try again.", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(noi_part3_deBai_1.this, "Recognition error: " + error, Toast.LENGTH_SHORT).show();
                }
            }
                ...
                if (matches != null && !matches.isEmpty()) {
                    ...
                    gemini.evaluate(prompt, new GeminiEvaluator.Callback() {
                        ...
                        public void onSuccess(String feedback) {
                            runOnUiThread(() -> {
                                new AlertDialog.Builder(noi_part3_deBai_1.this)
                                        .setTitle("Feedback")
                                        .setMessage(feedback)
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(noi_part3_deBai_1.this, noi_part3_deBai_2.class);
                                                startActivity(intent);
                                                finish();
                                            }
                                        })
